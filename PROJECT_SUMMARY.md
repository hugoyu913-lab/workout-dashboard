...
- Rule-based weekly insight panel for progression scores, progressing/stalled/declining exercise flags, undertrained muscle groups, weekly training score, push/pull/legs balance, and suggested focus for the next week. This is local deterministic logic, not an API call.
